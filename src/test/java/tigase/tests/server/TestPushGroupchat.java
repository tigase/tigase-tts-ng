 ...
 */
public class TestPushGroupchat
	...
	public void setUp() throws Exception {
		...
		userJaxmpp.getModule(PushNotificationModule.class)
		...
		assertTrue(mutex.isItemNotified("push:enabled:success"));
	...
	public void testPushDeliveryOnlineNotJoined() throws Exception {
		...
		Jaxmpp userJaxmpp2 = user.createJaxmpp().setConnected(true).build();
	...
	private static class DummyPushModule
		...
		private interface PushReceivedHandler
			...
			class PushReceivedEvent
					extends JaxmppEvent<PushReceivedHandler> {
				...
				@Override
				public void dispatch(PushReceivedHandler handler) throws Exception {
